...
namespace XFC.Helper
{
    public class PrintSqlGenerateHelper_Pump2
    {
        ...
        {
            fromtable = @"(PumpLab inner join PumpBasicInfo on PumpLab.PumpID=PumpBasicInfo.PumpID) inner join PumpPumpConditionRecord on PumpLab.PumpLabID=PumpPumpConditionRecord.PumpLabID";
        }
